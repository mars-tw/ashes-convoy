...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R74",
  "src/version.js?v=R74",
  "src/sprites.js?v=R74",
  "src/sprite-renderer.js?v=R74",
  "src/shelter-scene.js?v=R74",
  "src/config.js?v=R74",
  "src/rules.js?v=R74",
  "src/fx.js?v=R74",
  "src/audio.js?v=R74",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R74",
  "assets/shelter/trailer/crayon_drawing.png?v=R74",
  "assets/shelter/trailer/star_telescope.png?v=R74",
  "assets/shelter/trailer/photo_frame.png?v=R74",
  "assets/icons/icon-192.png?v=R74",
