...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R71",
  "src/version.js?v=R71",
  "src/sprites.js?v=R71",
  "src/sprite-renderer.js?v=R71",
  "src/shelter-scene.js?v=R71",
  "src/config.js?v=R71",
  "src/rules.js?v=R71",
  "src/fx.js?v=R71",
  "src/audio.js?v=R71",
...
const ASSET_PATHS = [
  ...
  "assets/enemies/kenney_armored_brute_walk.png",
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R71",
  "assets/shelter/trailer/crayon_drawing.png?v=R71",
  "assets/shelter/trailer/star_telescope.png?v=R71",
  "assets/shelter/trailer/photo_frame.png?v=R71",
  "assets/icons/icon-192.png?v=R71",
