...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R58",
  "src/version.js?v=R58",
  "src/sprites.js?v=R58",
  "src/sprite-renderer.js?v=R58",
  "src/shelter-scene.js?v=R58",
  "src/config.js?v=R58",
  "src/rules.js?v=R58",
  "src/fx.js?v=R58",
  "src/audio.js?v=R58",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R58",
  "assets/shelter/trailer/crayon_drawing.png?v=R58",
  "assets/shelter/trailer/star_telescope.png?v=R58",
  "assets/shelter/trailer/photo_frame.png?v=R58",
  "assets/icons/icon-192.png?v=R58",
