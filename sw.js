...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R57",
  "src/version.js?v=R57",
  "src/sprites.js?v=R57",
  "src/sprite-renderer.js?v=R57",
  "src/shelter-scene.js?v=R57",
  "src/config.js?v=R57",
  "src/rules.js?v=R57",
  "src/fx.js?v=R57",
  "src/audio.js?v=R57",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R57",
  "assets/shelter/trailer/crayon_drawing.png?v=R57",
  "assets/shelter/trailer/star_telescope.png?v=R57",
  "assets/shelter/trailer/photo_frame.png?v=R57",
  "assets/icons/icon-192.png?v=R57",
