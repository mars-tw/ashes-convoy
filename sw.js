...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R83.1",
  "src/version.js?v=R83.1",
  "src/sprites.js?v=R83.1",
  "src/sprite-renderer.js?v=R83.1",
  "src/shelter-scene.js?v=R83.1",
  "src/config.js?v=R83.1",
  "src/rules.js?v=R83.1",
  "src/fx.js?v=R83.1",
  "src/audio.js?v=R83.1",
  "src/game.js?v=R83.1",
  "src/ui.js?v=R83.1"
];
const ASSET_PATHS = [
  "assets/ui/start.png?v=R83.1",
  ...
  "assets/vehicles/xi_gunner_attack.png",
  ...
  "assets/enemies/oga_shambler_attack.png",
  "assets/enemies/oga_runner_attack.png",
  "assets/enemies/bloater_attack.png",
  "assets/enemies/oga_spitter_attack.png",
  "assets/enemies/shield_husk_attack.png",
  "assets/enemies/swarm_mite_attack.png",
  "assets/enemies/tar_brute_attack.png",
  "assets/enemies/void_wraith_attack.png",
  "assets/enemies/titan_attack.png",
  ...
  "assets/shelter/trailer/base_escape_pod.png?v=ad41b8f7",
  "assets/shelter/trailer/base_escape_pod-medium.png?v=757c8db7",
  "assets/shelter/trailer/base_escape_pod-low.png?v=027c13ed",
  "assets/shelter/trailer/room-art-manifest.json",
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R83.1",
  "assets/shelter/trailer/crayon_drawing.png?v=R83.1",
  "assets/shelter/trailer/star_telescope.png?v=R83.1",
  "assets/shelter/trailer/photo_frame.png?v=R83.1",
  "assets/icons/icon-192.png?v=R83.1",
