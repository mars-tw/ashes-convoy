...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R66",
  "src/version.js?v=R66",
  "src/sprites.js?v=R66",
  "src/sprite-renderer.js?v=R66",
  "src/shelter-scene.js?v=R66",
  "src/config.js?v=R66",
  "src/rules.js?v=R66",
  "src/fx.js?v=R66",
  "src/audio.js?v=R66",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R66",
  "assets/shelter/trailer/crayon_drawing.png?v=R66",
  "assets/shelter/trailer/star_telescope.png?v=R66",
  "assets/shelter/trailer/photo_frame.png?v=R66",
  "assets/icons/icon-192.png?v=R66",
