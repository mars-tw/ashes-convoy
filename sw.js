...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R68",
  "src/version.js?v=R68",
  "src/sprites.js?v=R68",
  "src/sprite-renderer.js?v=R68",
  "src/shelter-scene.js?v=R68",
  "src/config.js?v=R68",
  "src/rules.js?v=R68",
  "src/fx.js?v=R68",
  "src/audio.js?v=R68",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R68",
  "assets/shelter/trailer/crayon_drawing.png?v=R68",
  "assets/shelter/trailer/star_telescope.png?v=R68",
  "assets/shelter/trailer/photo_frame.png?v=R68",
  "assets/icons/icon-192.png?v=R68",
