...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R72",
  "src/version.js?v=R72",
  "src/sprites.js?v=R72",
  "src/sprite-renderer.js?v=R72",
  "src/shelter-scene.js?v=R72",
  "src/config.js?v=R72",
  "src/rules.js?v=R72",
  "src/fx.js?v=R72",
  "src/audio.js?v=R72",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R72",
  "assets/shelter/trailer/crayon_drawing.png?v=R72",
  "assets/shelter/trailer/star_telescope.png?v=R72",
  "assets/shelter/trailer/photo_frame.png?v=R72",
  "assets/icons/icon-192.png?v=R72",
