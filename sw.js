...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R75",
  "src/version.js?v=R75",
  "src/sprites.js?v=R75",
  "src/sprite-renderer.js?v=R75",
  "src/shelter-scene.js?v=R75",
  "src/config.js?v=R75",
  "src/rules.js?v=R75",
  "src/fx.js?v=R75",
  "src/audio.js?v=R75",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R75",
  "assets/shelter/trailer/crayon_drawing.png?v=R75",
  "assets/shelter/trailer/star_telescope.png?v=R75",
  "assets/shelter/trailer/photo_frame.png?v=R75",
  "assets/icons/icon-192.png?v=R75",
