...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R69",
  "src/version.js?v=R69",
  "src/sprites.js?v=R69",
  "src/sprite-renderer.js?v=R69",
  "src/shelter-scene.js?v=R69",
  "src/config.js?v=R69",
  "src/rules.js?v=R69",
  "src/fx.js?v=R69",
  "src/audio.js?v=R69",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R69",
  "assets/shelter/trailer/crayon_drawing.png?v=R69",
  "assets/shelter/trailer/star_telescope.png?v=R69",
  "assets/shelter/trailer/photo_frame.png?v=R69",
  "assets/icons/icon-192.png?v=R69",
