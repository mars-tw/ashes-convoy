...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R67",
  "src/version.js?v=R67",
  "src/sprites.js?v=R67",
  "src/sprite-renderer.js?v=R67",
  "src/shelter-scene.js?v=R67",
  "src/config.js?v=R67",
  "src/rules.js?v=R67",
  "src/fx.js?v=R67",
  "src/audio.js?v=R67",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R67",
  "assets/shelter/trailer/crayon_drawing.png?v=R67",
  "assets/shelter/trailer/star_telescope.png?v=R67",
  "assets/shelter/trailer/photo_frame.png?v=R67",
  "assets/icons/icon-192.png?v=R67",
