...
const APP_SHELL_PATHS = [
  ...
  "index.html",
  "offline.html",
  "manifest.webmanifest?v=R73",
  "src/version.js?v=R73",
  "src/sprites.js?v=R73",
  "src/sprite-renderer.js?v=R73",
  "src/shelter-scene.js?v=R73",
  "src/config.js?v=R73",
  "src/rules.js?v=R73",
  "src/fx.js?v=R73",
  "src/audio.js?v=R73",
...
const ASSET_PATHS = [
  ...
  "assets/story/xi.png",
  "assets/story/xi.png?v=R73",
  "assets/shelter/trailer/crayon_drawing.png?v=R73",
  "assets/shelter/trailer/star_telescope.png?v=R73",
  "assets/shelter/trailer/photo_frame.png?v=R73",
  "assets/icons/icon-192.png?v=R73",
