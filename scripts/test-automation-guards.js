...
assert.strictEqual(version.APP_VERSION, "R68");
...
assert(indexHtml.includes("ashes_convoy_html_boot_reload_R68"), "HTML boot guard should cover pre-JS service worker skew");
