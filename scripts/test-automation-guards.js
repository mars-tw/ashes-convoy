...
assert.strictEqual(version.APP_VERSION, "R77");
...
assert(indexHtml.includes("ashes_convoy_html_boot_reload_R77"), "HTML boot guard should cover pre-JS service worker skew");
