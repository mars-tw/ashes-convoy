...
assert.strictEqual(version.APP_VERSION, "R83.1");
...
assert(indexHtml.includes("ashes_convoy_html_boot_reload_R83.1"), "HTML boot guard should cover pre-JS service worker skew");
