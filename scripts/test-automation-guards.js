...
assert.strictEqual(version.APP_VERSION, "R73");
...
assert(indexHtml.includes("ashes_convoy_html_boot_reload_R73"), "HTML boot guard should cover pre-JS service worker skew");
