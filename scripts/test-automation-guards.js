...
assert.strictEqual(packageJson.version, `0.${version.APP_VERSION.slice(1)}.0`, "package version should match APP_VERSION");
...
assert(indexHtml.includes("ashes_convoy_html_boot_reload_R83"), "HTML boot guard should cover pre-JS service worker skew");
