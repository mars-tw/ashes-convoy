...
assert.strictEqual(version.APP_VERSION, "R55");
...
assert(indexHtml.includes("ashes_convoy_html_boot_reload_R55"), "HTML boot guard should cover pre-JS service worker skew");
