...
assert(shippedBytes < 1.5 * 1024 * 1024, `R70 derived asset budget exceeded: ${shippedBytes} bytes`);
...
assert(credits.includes("Characters, Zombies, and Weapons") && credits.includes("Top-down Tanks Remastered"), "CC0 animation and tank provenance must be documented");
