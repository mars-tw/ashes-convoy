...
assert.strictEqual(config.APP_VERSION, "R74");
assert.strictEqual(config.CACHE_VERSION, "ashes-convoy-r74-v1");
const indexHtml = fs.readFileSync(path.join(__dirname, "..", "index.html"), "utf8");
assert(indexHtml.includes("manifest.webmanifest?v=R74"), "index.html should version the web manifest for R74");
assert(indexHtml.includes("assets/icons/icon-192.png?v=R74"), "index.html should version the app icon for R74");
