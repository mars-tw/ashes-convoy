...
assert.strictEqual(config.APP_VERSION, "R75");
assert.strictEqual(config.CACHE_VERSION, "ashes-convoy-r75-v1");
const indexHtml = fs.readFileSync(path.join(__dirname, "..", "index.html"), "utf8");
assert(indexHtml.includes("manifest.webmanifest?v=R75"), "index.html should version the web manifest for R75");
assert(indexHtml.includes("assets/icons/icon-192.png?v=R75"), "index.html should version the app icon for R75");
